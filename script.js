...
function sliceStreetGeometryBetweenPoints(fullGeometry, lat1, lng1, lat2, lng2) {
    ...
    if (minDist1 > 60 || minDist2 > 60 || idx1 === -1 || idx2 === -1) return null;
...
function normalizeStreetKey(name) {
    ...
    s = s.replace(/^(strada statale|strada provinciale|strada regionale|strada|via|viale|corso|piazza|piazzale|vicolo|largo|borgo)\s+/g, '');
